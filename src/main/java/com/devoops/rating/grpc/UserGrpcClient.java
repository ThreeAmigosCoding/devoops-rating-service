...
import com.devoops.rating.grpc.proto.user.GetUserSummaryRequest;
import com.devoops.rating.grpc.proto.user.GetUserSummaryResponse;
import com.devoops.rating.grpc.proto.user.UserInternalServiceGrpc;
...
public class UserGrpcClient {
    ...
    public UserSummaryResult getUserSummary(UUID userId) {
        ...
        if (!response.getFound()) {
            return new UserSummaryResult(false, null, null, null, null, null, false);
        }
